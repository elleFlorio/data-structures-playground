...
public class ArrayQueueTests {
    ...
    @Test
    void enqueueDequeueTest() throws QueueErrorOverflow, QueueErrorUnderflow {
        Queue<Integer> queue = new ArrayQueue<>(Integer.class, 3);
    ...
    void errorOverflowTest() throws QueueErrorOverflow {
        Queue<Integer> queue = new ArrayQueue<>(Integer.class, 1);
        queue.enqueue(1);
